...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s eboost-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  eboost-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded eboost transaction") + "\n" +
              "  eboost-tx [options] -create [commands]   " + _("Create hex-encoded eboost transaction") + "\n" +
              "\n";
